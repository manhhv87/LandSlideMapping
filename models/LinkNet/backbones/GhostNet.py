...
class GhostNet(nn.Module):
    def __init__(self, cfgs, in_channel=3, num_classes=1000, width=1.0, dropout=0.2):
        ...
        self.conv_stem = nn.Conv2d(in_channel, output_channel, 3, 1, 1, bias=False)
...
def ghostnet(in_channel, **kwargs):
    """
    ...
    return GhostNet(cfgs, in_channel, **kwargs)
