...
class PyramidPooling(nn.Module):
    ...
    def forward(self, x):
        ...
        feat1 = F.interpolate(feat1, size=(
            h, w), mode='bilinear', align_corners=True)
        feat2 = F.interpolate(feat2, size=(
            h, w), mode='bilinear', align_corners=True)
        feat3 = F.interpolate(feat3, size=(
            h, w), mode='bilinear', align_corners=True)
        feat4 = F.interpolate(feat4, size=(
            h, w), mode='bilinear', align_corners=True)
...
class StripPooling(nn.Module):
    ...
    def forward(self, x):
        ...
        x2_2 = F.interpolate(x2_2, size=(
            h, w), mode='bilinear', align_corners=True)
        x2_3 = F.interpolate(x2_3, size=(
            h, w), mode='bilinear', align_corners=True)
        x2_4 = F.interpolate(x2_4, size=(
            h, w), mode='bilinear', align_corners=True)
        x2_5 = F.interpolate(x2_5, size=(
            h, w), mode='bilinear', align_corners=True)
