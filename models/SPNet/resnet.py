...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, in_ch=14, dilated=False, multi_grid=False,
...
def resnet50(in_ch=3, pretrained=None, **kwargs):
...
def resnet101(in_ch=3, pretrained=None, **kwargs):
