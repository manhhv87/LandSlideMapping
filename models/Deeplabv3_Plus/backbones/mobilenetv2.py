...
class MobileNetV2(nn.Module):
    def __init__(self, in_ch=3, n_class=1000, input_size=224, width_mult=1.):
        ...
        self.features = [conv_bn(in_ch, input_channel, 2)]
...
def mobilenetv2(in_ch=3, n_class=1000, pretrained=False, **kwargs):
    model = MobileNetV2(in_ch=in_ch, n_class=n_class, **kwargs)
    if pretrained:
        model.load_state_dict(load_url(
            'https://github.com/bubbliiiing/deeplabv3-plus-pytorch/releases/download/v1.0/mobilenet_v2.pth.tar'), strict=False)
    return model
